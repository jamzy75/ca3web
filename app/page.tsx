      ...
      <div className="mt-4 flex grow flex-col gap-4 md:flex-row">
        ...
        className={styles.shape}/>
          ...
          <Link
            ...
            className="flex items-center gap-5 self-start rounded-lg bg-purple-500 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-400 md:text-base"
          >
            <span>Accordion</span> <ArrowRightIcon className="w-5 md:w-6" />
          </Link>
          <Link
            href='/ui/Card'
            className="flex items-center gap-5 self-start rounded-lg bg-purple-500 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-400 md:text-base"
          >
            <span>Cards</span> <ArrowRightIcon className="w-5 md:w-6" />
          </Link>
          <Link
            href='/ui/data'
            className="flex items-center gap-5 self-start rounded-lg bg-purple-500 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-400 md:text-base"
          >
            <span>Data Table</span> <ArrowRightIcon className="w-5 md:w-6" />
          </Link>
          <Link
            href='/ui/ContactForm'
            className="flex items-center gap-5 self-start rounded-lg bg-purple-500 px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-400 md:text-base"
          >
            <span>Form</span> <ArrowRightIcon className="w-5 md:w-6" />
          </Link>
